...
##Pmod Header JA (XADC)
#set_property PACKAGE_PIN N15  [get_ports { vauxp6_0 }]
#set_property  IOSTANDARD LVCMOS33 [get_ports { vauxp6_0 }]

#set_property PACKAGE_PIN L14  [get_ports { vauxp7_0 }]
#set_property  IOSTANDARD LVCMOS33 [get_ports { vauxp7_0 }]

set_property PACKAGE_PIN K16  [get_ports { vauxp14_0 }]
set_property  IOSTANDARD LVCMOS33 [get_ports { vauxp14_0 }]

set_property PACKAGE_PIN K14  [get_ports { vauxp15_0 }]
set_property  IOSTANDARD LVCMOS33 [get_ports { vauxp15_0 }]

#set_property PACKAGE_PIN N16  [get_ports { vauxn6_0 }]
#set_property  IOSTANDARD LVCMOS33 [get_ports { vauxn6_0 }]

#set_property PACKAGE_PIN L15  [get_ports { vauxn7_0 }]
#set_property  IOSTANDARD LVCMOS33 [get_ports { vauxn7_0 }]

set_property PACKAGE_PIN J16  [get_ports { vauxn14_0 }]
set_property  IOSTANDARD LVCMOS33 [get_ports { vauxn14_0 }]

set_property PACKAGE_PIN J14  [get_ports { vauxn15_0 }]
set_property  IOSTANDARD LVCMOS33 [get_ports { vauxn15_0 }]
